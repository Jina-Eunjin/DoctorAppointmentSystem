...
const AddDoctor = () => {
    ...
    return (
        <form onSubmit={onSubmitHandler} className='m-5 w-full'>
            <p className='mb-3 text-lg font-medium'>Add Doctore</p>

            <div className='bg-white px-8 py-8 border border-gray-200 rounded w-full max-4-xl max-h-[80vh] overflow-y-scroll'>
                ...
                <div className='flex flex-col lg:flex-row items-start gap-10 text-gray-600'>
                    ...
                    <div className='w-full lg:flex-1 flex flex-col gap-4'>
                        ...
                        <div className='flex-1 flex flex-col gap-1'>
                            <p>Education</p>
                            <input onChange={(e) => setDegree(e.target.value)} value={degree} className='border border-gray-200 rounded px-3 py-2' type="text" placeholder='Eduction' required />
                        </div>
                ...
                <div>
                    ...
                    <textarea onChange={(e) => setAbout(e.target.value)} value={about} className='w-full px-4 pt-2 border border-gray-200 rounded' type="text" placeholder='Write about doctor' rows={5} required />
                </div>

                <button type='submit' className='bg-primary px-10 py-3 mt-4 rounded-full'>
                    Add doctore
                </button>
